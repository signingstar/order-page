...
const FinalizeSelection = ({filter, pathname, handleChange, willEnter, willLeave, getStyles, getDefaultStyles, value, updateFilter, totalCount, qualifiedCount, qualifyImage, unqualifyImage, handleModeChange, viewMode, finalizeOrder}) => {
