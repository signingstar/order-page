...
var MainPanel = function MainPanel(_ref) {
  ...
  return _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Link2.default,
            {
              ...
              isActive: function isActive(location) {
                return (!location.query || !location.query.album) && location.pathname.match(/^\/orders\/[a-z0-9]+\/preview$/);
              }
            },
            "All Photos"
          )
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_Match2.default, { exactly: true, pattern: "/orders/:orderId/preview", component: _image_arrangement2.default }),
      _react2.default.createElement(_Match2.default, { exactly: true, pattern: "/orders/:orderId/preview/addUser", component: _add_user2.default })
    )
  );
};
