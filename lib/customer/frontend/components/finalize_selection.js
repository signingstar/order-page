          ...
          styles.map(function (_ref2, index) {
            ...
            return _react2.default.createElement(
              ...
              viewMode === 'thumbnail' ? _react2.default.createElement(
                ...
                _react2.default.createElement("img", { src: "/" + JSON.parse(srcSet).thumbnail })
              ) : '',
              _react2.default.createElement(
                "div",
              ...
              _react2.default.createElement(
                ...
                filter === _actions.QUALIFIED ? _react2.default.createElement(
                  "button",
                  { className: "glyph", type: "button", onClick: unqualifyImage.bind(null, id, album_id) },
                ...
                filter === _actions.UNQUALIFIED ? _react2.default.createElement(
                  "button",
                  { className: "glyph", type: "button", onClick: qualifyImage.bind(null, id, album_id) },
