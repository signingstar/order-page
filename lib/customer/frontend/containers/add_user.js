...
var AddUserHandler = function (_Component) {
  ...
  AddUserHandler.prototype.onSubmit = function onSubmit(e, input) {
    ...
    var addUserToStore = _props.addUserToStore;
    ...
    (0, _actions.addUser)({ emailid: emailid, role: role, order_id: order_id }, function () {
      return addUserToStore(emailid, role);
    });
    input.value = '';
  };
  ...
  AddUserHandler.prototype.render = function render() {
    ...
    var roleNodes = [{ value: 5, label: 'Admin - Full Access' }, { value: 3, label: 'Contributor - Limited Access' }, { value: 1, label: 'Visitor - View Access' }];
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addUserToStore: function addUserToStore(email, role) {
