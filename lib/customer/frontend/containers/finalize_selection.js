...
var FinalizeSelection = function (_Component) {
  ...
  FinalizeSelection.prototype.getDefaultStyles = function getDefaultStyles() {
    ...
    return imageIdList.map(function (imageId) {
      return { data: Object.assign({}, images[imageId], { imageId: imageId, albumName: albums[images[imageId]] }), key: imageId, style: { height: 0, opacity: 1 } };
    });
  };
  ...
  FinalizeSelection.prototype.getQualifiedImages = function getQualifiedImages() {
    ...
    return imageIdList.filter(function (imageId) {
      ...
      var qualified = _this2.isQualifyingImage(_actions.QUALIFIED, score, force_qualify);
  ...
  FinalizeSelection.prototype.getStyles = function getStyles() {
    ...
    return imageIdList.filter(function (imageId) {
      ...
      return _this3.isQualifyingImage(filter, score, force_qualify);
