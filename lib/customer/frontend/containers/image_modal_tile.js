...
var ImageModalTileConfiguration = function (_Component) {
  ...
  ImageModalTileConfiguration.prototype.getNextLink = function getNextLink(index, originalUrl) {
    var images = this.props.images;
    ...
    return _react2.default.createElement(
      ...
      { to: {
          ...
          state: { originalUrl: originalUrl, fromModal: true, index: index + 1 }
        }
      },
      "Next"
    );
  ...
  ImageModalTileConfiguration.prototype.getPreviousLink = function getPreviousLink(index, originalUrl) {
    var images = this.props.images;
  ...
  ImageModalTileConfiguration.prototype.render = function render() {
    ...
    var isShowing = _props.isShowing;
    var images = _props.images;
    var pathname = _props.pathname;
    var params = _props.params;
    var state = _props.state;
    var originalUrl = _props.originalUrl;
    var index = this.state.index;

    var image = Object.assign({}, images[index], { index: index });

    var previousLink = index > 0 ? this.getPreviousLink(index, originalUrl) : undefined;
    var nextLink = index < images.length - 1 ? this.getNextLink(index, originalUrl) : undefined;
