  ...
  return {
    viewCustomer: function viewCustomer(_ref2) {
      ...
      _async2.default.waterfall([function (done) {
        ...
        (0, _react_server2.default)({ location: location, orderResult: orderResult, images: images, imageReaction: imageReaction }, localModule, function (err, reactHTML, preloadedState) {
          if (err) {
