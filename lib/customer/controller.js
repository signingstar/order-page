...
var controller = function controller(_ref) {
  ...
  return {
      ...
      _async2.default.waterfall([function (done) {
        _async2.default.parallel({
          orderResult: function orderResult(cb) {
            (0, _view_order.viewCustomerOrder)(orderQueryData, localModule, function (err, orderResults) {
              var orderResult = orderResults[0];
    ...
    deactivateUser: function deactivateUser(_ref6) {
