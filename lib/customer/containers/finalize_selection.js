...
var _finalize_selection = require("../components/finalize/finalize_selection");
...
var ConfigureFinalize = function (_Component) {
  ...
  function ConfigureFinalize() {
    ...
    _this.finalizeOrder = _this.finalizeOrder.bind(_this);
  ...
  ConfigureFinalize.prototype.finalizeOrder = function finalizeOrder(e) {
    e.preventDefault();
    var _props2 = this.props,
        order_id = _props2.order_id,
        updateOrder = _props2.updateOrder;
  ...
  ConfigureFinalize.prototype.assignScoreToImages = function assignScoreToImages() {
    var _props5 = this.props,
        ...
        imageIdList = _props5.imageIdList,
        updateScoreInStore = _props5.updateScoreInStore;
  ...
  ConfigureFinalize.prototype.unqualifyImage = function unqualifyImage(imageId, albumId) {
    var _props7 = this.props,
        updateImageQualificationInStore = _props7.updateImageQualificationInStore,
        order_id = _props7.order_id;
  ...
  ConfigureFinalize.prototype.render = function render() {
    var _props8 = this.props,
        imageIdList = _props8.imageIdList,
        pathname = _props8.pathname;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    updateOrder: function updateOrder(order_id) {
      dispatch((0, _actions.finalizeOrder)({ order_id: order_id }));
    }
  };
};
