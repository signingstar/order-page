...
var ImagesLikedByPersonConfiguration = function (_Component) {
  ...
  ImagesLikedByPersonConfiguration.prototype.render = function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_content2.default, { filter: this.state.filter, user: this.state.user, previewMode: this.state.view, pathname: this.props.pathname })
    );
  };
