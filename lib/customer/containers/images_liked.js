...
var _images_by_reaction = require("../components/images_by_reaction");

var _images_by_reaction2 = _interopRequireDefault(_images_by_reaction);
...
var GroupLikedImages = function (_Component) {
  ...
  GroupLikedImages.prototype.render = function render() {
    ...
    return _react2.default.createElement(_images_by_reaction2.default, { images: this.state.images, pathname: this.props.pathname, previewMode: previewMode });
  };
...
//# sourceMappingURL=images_liked.js.map