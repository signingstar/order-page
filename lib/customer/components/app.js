...
var App = function App(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Match2.default, { pattern: '/order/:usersHash/:orderId', component: _home2.default }),
    _react2.default.createElement(MatchImage, { pattern: '/order/:usersHash/:orderId/:fileName', component: _image_modal2.default })
  );
};
...
var MatchImage = function MatchImage(_ref2) {
  ...
  return _react2.default.createElement(_Match2.default, _extends({}, rest, {
    render: function render(matchProps) {
      var imageId = matchProps.params.fileName;

      return imageId.match(/^[a-z0-9]{32}$/) ? _react2.default.createElement(Component, matchProps) : null;
    }
  }));
};
