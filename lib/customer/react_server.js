...
var albumifyImages = function albumifyImages(imageList, albums) {
  var images = {};

  albums.forEach(function (album, index) {
    return images[album.album_id.toString()] = { album_name: album.album_name, priority: index + 1, files: [] };
  });

  imageList.forEach(function (image) {
    return images[image.album_id].files.push(image);
  });
...
var ReactComponent = function ReactComponent(location, _ref, _ref2, cb) {
  ...
  var imageReaction = _ref.imageReaction;
