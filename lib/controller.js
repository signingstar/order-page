...
var _add_album = require("./request_builders/add_album");
  ...
  return {
    ...
    create: function create(_ref3) {
      ...
      (0, _api_executor.createOrder)({ formData: formData, session: session }, { logger: logger, queryDb: queryDb }, function (_ref4) {
        ...
        (0, _add_album.addAlbum)({ order_id: order_id }, { redisClient: redisClient }, function (err, result) {
    ...
    viewOwner: function viewOwner(_ref10) {
