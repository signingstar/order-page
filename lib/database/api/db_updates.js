...
exports.persistConfirmOrder = exports.updateOrderToConfirm = exports.updateUser = exports.addUser = exports.updateOrder = undefined;
...
var persistConfirmOrder = exports.persistConfirmOrder = function persistConfirmOrder() {
  ...
  return updateDatabaseEntry.apply(undefined, [_update.saveFileList].concat(args));
};
