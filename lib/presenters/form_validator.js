...
var validateOrderData = exports.validateOrderData = function validateOrderData(_ref) {
  ...
  var orderData = { product: product, first_name: first_name, last_name: last_name, email: email, phone_number: phone_number, image_count: image_count };
  if (id) {
    orderData.id = id;
  }
...
var validateConfirmOrderData = exports.validateConfirmOrderData = function validateConfirmOrderData(_ref5) {
  ...
  var order_name = _ref5.order_name;
  ...
  var orderData = { order_id: order_id, order_name: order_name, category: category };
