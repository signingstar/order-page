...
exports.confirmOrder = exports.processOrder = exports.createOrder = undefined;
...
var processOrder = exports.processOrder = function processOrder(_ref3, _ref4, cb) {
  ...
  var userid = user.id;
  var queryParams = [userid, order_id, 'in_process'];
...
var confirmOrder = exports.confirmOrder = function confirmOrder(_ref5, _ref6, cb) {
  ...
  var userid = user.id;
  var queryParams = [userid, order_id, 'confirmed'];
