...
var _upload_files_contents = require("../components/upload_files_contents");

var _upload_files_contents2 = _interopRequireDefault(_upload_files_contents);
...
var UploadFiles = function (_React$Component) {
  ...
  UploadFiles.prototype.render = function render() {
    ...
    return _react2.default.createElement(_upload_files_contents2.default, {
      label: label,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    onDrop: function onDrop(files) {
      return dispatch((0, _actions.setFiles)(files));
    }
  };
};
