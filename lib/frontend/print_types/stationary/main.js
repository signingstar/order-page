...
var Container = function (_React$Component) {
  ...
  _createClass(Container, [{
    ...
    key: "getComponent",
    value: function getComponent(category, filterList, fieldsLabel) {
      var component = void 0;

      switch (category) {
        case 'envelope':
          component = _react2.default.createElement(_envelope2.default, { filterList: filterList, fieldsLabel: fieldsLabel });
          break;
        case 'letterhead':
          component = _react2.default.createElement(_envelope2.default, { filterList: filterList, fieldsLabel: fieldsLabel });
          break;
    ...
    value: function getLabelForFields(_ref) {
      ...
      var categoryLabel = this.presenter.fetchLabelForCategoryAndId(_index.CATEGORY, category);
    ...
    key: "getFilterList",
    value: function getFilterList(_ref2) {
      ...
      return { sizeList: sizeList, materialList: materialList, coatList: coatList, quantityList: quantityList };
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var filterList = this.getFilterList(this.props);
