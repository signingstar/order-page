...
var VisitingCard = function (_React$Component) {
  ...
  _createClass(VisitingCard, [{
    ...
    value: function getLabelForFields(_ref) {
      ...
      labelMap.set(_index.TEMPLATE, { label: 'Template', value: template ? 'true' : 'false' });
    ...
    value: function render() {
      ...
      var fieldsLabel = this.getLabelForFields({ category: category, paper_quality: paper_quality, coat: coat, quantity: quantity, template: template });
...
var mapStateToProps = function mapStateToProps(orderApp, ownProps) {
  ...
  var template = _orderApp$selectionSt.template;
