...
var _create_order = require('../containers/create_order');

var _create_order2 = _interopRequireDefault(_create_order);

var _process_order = require('../containers/process_order');

var _process_order2 = _interopRequireDefault(_process_order);

var _confirm_order = require('../containers/confirm_order');
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Match2.default, { pattern: '/order/products', component: _product_list2.default }),
    _react2.default.createElement(_Match2.default, { pattern: '/order/create', component: _create_order2.default }),
    _react2.default.createElement(_Match2.default, { pattern: '/order/process', component: _process_order2.default }),
