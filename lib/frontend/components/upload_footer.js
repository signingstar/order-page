  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('input', { className: 'queue', type: 'button', value: 'Add Images', onClick: onAddImage })
      ),
      _react2.default.createElement(
        'div',
        { className: 'upload-action' },
        _react2.default.createElement('input', { className: 'upload', type: 'submit', value: 'Start Upload', disabled: queued ? false : true })
      )
    ),
    _react2.default.createElement(
      'div',
