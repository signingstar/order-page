...
var ReactComponent = function ReactComponent(_ref, _ref2, cb) {
  ...
  var orderInfo = function orderInfo(cb) {
    return viewOrder({ orderid: orderid, userid: userid }, cb);
  };

  var requests = { products: products, categories: categories, orderInfo: orderInfo };
