...
var imageMapToList = exports.imageMapToList = function imageMapToList(albums) {
  ...
  var imageList = keys.map(function (albumId) {
    var _albums$albumId = albums[albumId],
        id = _albums$albumId.id,
        name = _albums$albumId.name,
        priority = _albums$albumId.priority,
        _albums$albumId$files = _albums$albumId.files,
        files = _albums$albumId$files === undefined ? [] : _albums$albumId$files;
